...
import type { ICourseRepository, ICourseFinder } from '@courses/domain/ports';
import { type FindAllCoursesFilters } from '@modules/courses/domain/ports/course.repository.port';
import { CoursePersistenceMapper } from '../mappers';

@Injectable()
export class CoursePrismaRepository
  implements ICourseRepository, ICourseFinder
{
